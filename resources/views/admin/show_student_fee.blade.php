...
<body>
    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-light rounded p-4">
            <h6 class="mb-4">Add Student Monthly Fee</h6>
            <div class="card">
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="javascript:void(0);" class="btn btn-warning btn-sm custom-btn-spacing" onclick="openFeeVoucherModal('{{ url('admin/generate/voucher') }}', '{{ $fee->student_id }}', '{{ $fee->student_name }}', '{{ $fee->student_campus }}', '{{ $fee->fees_amount }}')">Generate Fees Voucher</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="feeVoucherForm" action="{{ url('admin/generate/voucher') }}" method="POST">
                        @csrf
