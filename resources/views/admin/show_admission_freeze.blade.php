                        ...
                        <tbody>
                            @foreach($show_freeze_details as $show_details)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <form action="{{ route('updateFeeStatus', ['id' => $show_details->id]) }}" method="POST" style="margin-right: 5px;">
                                                @csrf
                                            ...
                                            <form action="{{ route('updateFeeStatus', ['id' => $show_details->id]) }}" method="POST">
                                                @csrf
