...
<div class="modal fade" id="studentModal{{ $information->id }}" tabindex="-1" aria-labelledby="studentModalLabel{{ $information->id }}" aria-hidden="true">
    ...
    @endif
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-sm" onclick="confirmedit('{{ url('/admin/edit_staff_information', $information->id) }}')">Edit Information</button>
                <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete('{{ url('/admin/delete_staff_information', $information->id) }}')">Delete Information</button>
            </div>
        </div>
    </div>
</div>
