...
<div class="full-height">
    <div class="custom-width">
        <div class="bg-light-rounded">
            <form id="staff-form" action="{{route ('updating_staff_information', ['id' => $staff_data->id] ) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="row">
                    ...
                    <div class="form-floating">
                        ...
                        <div class="form-floating">
                        <textarea class="form-control" id="previous_work_experience" name="previous_work_experience" placeholder="Previous Work Experience" required>{{ $staff_data->previous_work_experience }}</textarea>
