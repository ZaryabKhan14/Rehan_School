                    ...
                    <table class="table table-bordered table-striped" id="example" style="wdith:200%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a href="javascript:void(0);" class="btn btn-warning btn-sm custom-btn-spacing" onclick="confirmEdit('{{ url('/principle/adding_staff_information', $staff->id) }}')">Add Staff Information</a>
                                </div>
