                    ...
                    <table class="table table-bordered table-striped" id="example" style="wdith:200%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a href="javascript:void(0);" class="btn btn-warning btn-sm custom-btn-spacing" onclick="confirmEdit('{{ url('principle/edit_user', $user->id) }}')">Edit</a>
                                <a href="javascript:void(0);" class="btn btn-danger btn-sm custom-btn-spacing" onclick="confirmDelete('{{ route('principle_delete_user', $user->id) }}')">Delete</a>
                                </div>
