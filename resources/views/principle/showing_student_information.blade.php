                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('generate_student_pdf', ['student_id' => $information->id]) }}" class="btn btn-info btn-sm">Download PDF</a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-sm" onclick="confirmedit('{{ url('/principle/edit_student_information', $information->id) }}')">Edit Information</button>
                <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete('{{ url('/principle/delete_information_student', $information->id) }}')">Delete Information</button>
            </div>
        </div>
    </div>
</div>
