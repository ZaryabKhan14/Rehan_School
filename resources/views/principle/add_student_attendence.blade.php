                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <!-- Present Button -->
                            <a class="btn btn-sm btn-success" href="javascript:void(0);" onclick="confirmAction('{{ url('principle/attendance/present', $student->student_id) }}', 'present')">
                                Present
                            </a>
                            <!-- Absent Button -->
                            <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="confirmAction('{{ url('principle/attendance/absent', $student->student_id) }}', 'absent')">
                                Absent
                            </a>
                        </td>
                    </tr>
