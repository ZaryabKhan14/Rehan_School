...
<div class="full-height">
    <div class="col-10 custom-width">
        <div class="bg-light-rounded">
            ...
            <form id="addUserForm" action="{{ route('add_student_form') }}" method="POST">
                @csrf
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="role" name="role" value="student" placeholder="Role" readonly>
