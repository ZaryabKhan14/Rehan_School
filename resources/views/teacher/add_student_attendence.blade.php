                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <!-- Present Button -->
                            <a class="btn btn-sm btn-success" href="javascript:void(0);" onclick="confirmAction('{{ url('teacher/attendance/present', $student->user->id) }}', 'present')">
                                Present
                            </a>
                            <!-- Absent Button -->
                            <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="confirmAction('{{ url('teacher/attendance/absent', $student->user->id) }}', 'absent')">
                                Absent
                            </a>
                        </td>
                    </tr>
