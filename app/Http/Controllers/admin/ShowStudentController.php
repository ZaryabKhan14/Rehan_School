...
class ShowStudentController extends Controller
{
    public function show_students(){
        ...
        return view('admin.show_student_infor',compact('students'));
    }

    public function student_information($id){
        $students = User::find($id);
        return view('admin.student_information_form',compact('students'));
    }

    public function add_student_information(Request $request){
        ...
        if ($request->hasFile('image')) {
            ...
            $add_student_information->profile_image = $path;
        }        
    ...
    return redirect()->route('show_students')->with('success', 'Student added successfully');
}
