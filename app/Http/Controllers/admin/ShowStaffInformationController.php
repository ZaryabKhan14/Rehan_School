...
class ShowStaffInformationController extends Controller
{
    public function show_staff_information(){
        $staff = Staff_Information::all();
        return view('admin.show_staff_information',compact('staff'));
    }

    public function delete_staff_information($id){
    ...
    public function edit_form($id){
        ...
        return view('admin.edit_staff_data',compact('staff_data'));        
    }

    public function update_staff_information(Request $request,$id){
        ...
        return redirect()->route('show_staff_information')->with('success', 'Staff information added successfully!');
    }
